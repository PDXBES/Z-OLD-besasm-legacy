...
namespace SystemsAnalysis.Characterization
{
	...
	public class CharacterizationEngine
	{
		...
		{			
			...
			this.agMasterDB = settings.DataSource.Rows.Find("AGMasterDB").ToString();
			this.resultsWarehouseDB = settings.DataSource.Rows.Find("ResultsWarehouseDB").ToString();
			this.psDB = settings.DataSource.Rows.Find("PumpStationDB").ToString();
			this.template = settings.DataSource.Rows.Find("CharTemplate").ToString();
			this.outputFile = settings.DataSource.Rows.Find("OutputDir").ToString() + "Char_" + studyArea + ".xml";
			this.uicDB = settings.DataSource.Rows.Find("UICDB").ToString();
			this.mstSurfSC_FC = settings.DataSource.Rows.Find("MstSSC").ToString();
