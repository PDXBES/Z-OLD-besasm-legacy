...
namespace SWI_2
{
    public partial class SWIInputForm : Form
    {
        ...
        private void DoImport()
        {
            ...
            string query = "SELECT CAST(SYSTEM_USER AS varchar(128))";
            string userID = "";
        ...
        private void datatable1DataGridView_DefaultValuesNeeded(object sender, DataGridViewRowEventArgs e)
        {
            ...
            e.Row.Cells["global_id"].Value = returnValue;
            ...
            e.Row.Cells["view_id"].Value = ((DataRowView)this.sWSPSUBWATERSHEDEditableViewsBindingSource.Current)["view_id"];
            e.Row.Cells["survey_page_id"].Value = ((DataRowView)this.editableViewsEditableSurveyPagesBindingSource.Current)["survey_page_id"];
            e.Row.Cells["watershed_id"].Value = ((DataRowView)this.sWSPWATERSHEDBindingSource.Current)["watershed_id"];
            e.Row.Cells["subwatershed_id"].Value = ((DataRowView)this.fKSUBWATERSHEDWATERSHEDBindingSource.Current)["subwatershed_id"];
        }
        ...
        private void SWIInputForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.ActiveControl == this.dataGridView2)
            {
                try
                {
                    dataGridView2.CurrentRow.DataGridView.EndEdit();
                }
                catch (Exception ex)
                {
                }
                ...
                CurrencyManager cm = (CurrencyManager)dataGridView2.BindingContext[dataGridView2.DataSource, dataGridView2.DataMember];
                cm.EndCurrentEdit();
            ...
            if (this.ActiveControl == this.dataGridViewPhotos)
            {
                try
                {
                    ...
                    dataGridViewPhotos.CurrentRow.DataGridView.EndEdit();
                }
                catch (Exception ex)
                {
                }
                ...
                CurrencyManager cm = (CurrencyManager)dataGridViewPhotos.BindingContext[dataGridViewPhotos.DataSource, dataGridViewPhotos.DataMember];
                cm.EndCurrentEdit();
        ...
        private void dataGridViewPhotos_DefaultValuesNeeded(object sender, DataGridViewRowEventArgs e)
        {
            //Global ID should be the result
            int returnValue = -1;
            string query = "INSERT INTO [SWI].[dbo].[SWSP_PHOTOS] (global_id) OUTPUT inserted.photo_id VALUES (" + ((DataRowView)this.editableSurveyPagesdatatable1BindingSource.Current)["global_id"] + ")";
            returnValue = ExecuteScalar(query, myConnectionString, returnValue);

            e.Row.Cells["photo_id"].Value = returnValue;
        }
        ...
        private void newPageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FormAddNewSurveyPage child = new FormAddNewSurveyPage();
        ...
        {
            //get the page the user wants to insert
            FormAddNewView child = new FormAddNewView();
