...
ErrHandler:
        ...
        Throw New System.Exception("CallIMUT Error: " & Err.Description & ".", Err.GetException)
    End Function
    ...
    Optional ByVal strLogFile As String = "\\cassio\modeling\model_programs\GISTranslator\log.txt", _
    ...
    Public Function translateFromAccessTable(ByVal sTranslationDB As String, ByVal sTable As String, ByVal sOutputDB As String, Optional ByVal sLogFile As String = "\\cassio\modeling\model_programs\GISTranslator\log.txt")
