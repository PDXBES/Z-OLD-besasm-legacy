...
namespace SystemsAnalysis.Types
{
    ...
    public class Enumerators
    {
        ...
        {
            NoDetermination = 0, Unsewerable, Sewerable, Sewered, Septic
        };
        ...
        {
            Static, NewDevelopment, Redevelopment, Undevelopable, Unspecified
        }
        ...
        {
            WillNotConnect, ConnectedNoChange, ConnectedFutureRedevelopment, FutureNewConnection, Unspecified
        }
        ...
        public static LinkTypes GetLinkTypeEnum(string LinkTypeCode)
        {
            ...
            else if (LinkTypeCode.IndexOf("C") != -1)
            {
                return Types.Enumerators.LinkTypes.C;
            }
            else if (LinkTypeCode.IndexOf("D") != -1)
            {
                return Types.Enumerators.LinkTypes.D;
            }
            else if (LinkTypeCode.IndexOf("S") != -1)
            {
