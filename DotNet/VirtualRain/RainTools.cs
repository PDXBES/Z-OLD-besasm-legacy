...
namespace VirtualRain
{
    ...
    class RainTools
    {
            ...
            DataTable graphData)
        {
            ...
            SqlConnection myConnection = new SqlConnection("Data Source=Reportsio;Initial Catalog=NEPTUNE;Integrated Security=SSPI;");
            ...
            SqlConnection myDTConnection = new SqlConnection("Data Source=Reportsio;Initial Catalog=NEPTUNE;Integrated Security=SSPI;");
            ...
            try
            {
                ...
                try
                {
                    string QSQuery = "SELECT QTRNO,Qs_x,Qs_y FROM QS_Data WHERE " + lblInstructions1 + " ORDER BY QTRNO";
