...
namespace VirtualRain
{
    ...
    public class SplashScreen : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTimeRemaining.Text = "Loading Rain Tools...";
            // 
            // timer1
            // 
             ...
             System.Windows.Forms.PaintEventArgs e)
        {
            if (m_bFirstLaunch == false && e.ClipRectangle.Width > 0
                  && m_iActualTicks > 1)
            {
                //07apr08 addition for 'width/height cannot equal zero' error
                if (m_rProgress.Width < 1) m_rProgress.Width = 1;
                if (m_rProgress.Height < 1) m_rProgress.Height = 1;
                //07apr08
