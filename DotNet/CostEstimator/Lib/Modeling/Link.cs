...
namespace SystemsAnalysis.Modeling
{
  ...
  public class Link : IGraphEdge
  {
    ...
    bool IGraphEdge.IsSelected
    {
      get
      {
        return this.linkEdge.IsSelected;
      }
      set
      {
        this.linkEdge.IsSelected = value;
      }
    }
    #endregion
    ...
    public bool IsGravityFlow
    {
      get
      {
        return this.pipeFlowType != Enumerators.PipeFlowTypes.F;
      }
    }
    /// <summary>
