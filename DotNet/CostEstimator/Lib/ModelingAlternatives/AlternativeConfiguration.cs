...
namespace SystemsAnalysis.Modeling.Alternatives
{
  partial class AlternativeConfiguration
  {
      ...
      : this()
    {
      ...
      sr.Close();
      if (configText.Contains("AlternativesBuilder"))
        PatchConfig_1();
      if (configText.Contains("AlternativesToolkit"))
        PatchConfig_2();
    ...
    public string BaseModel
    {
      get
      {
        return this.tableAlternativeConfiguration[0].BaseModel;
      }
    ...
    public string AlternativeName
    {
      get
      {
        return this.tableAlternativeConfiguration[0].Name;
      }
      //set { this.baseModel = value; }
    }
    ...
    public string AlternativeVersion
    {
      get
      {
        return this.tableAlternativeConfiguration[0].Version;
      }
    }
