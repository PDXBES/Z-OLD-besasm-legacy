  ...
  public class Dsc
  {
        ...
        if (this.developmentState == Enumerators.DevelopmentState.Unspecified)
        {
          switch (sewerable)
          {
            case Enumerators.Sewerable.Sewered:
              if (WillDevelop) this.developmentState = Enumerators.DevelopmentState.Redevelopment;
              else this.developmentState = Enumerators.DevelopmentState.Static;
              break;
    ...
    public Enumerators.ConnectionAssumption ConnectionAssumption
    {
      get
      {
        ...
        {
          case Enumerators.Sewerable.Sewered:
            if (WillDevelop) this.connectionAssumption = Enumerators.ConnectionAssumption.ConnectedFutureRedevelopment;
            else this.connectionAssumption = Enumerators.ConnectionAssumption.ConnectedNoChange;
            break;
          case Enumerators.Sewerable.Sewerable:
    ...
    /// </summary>
    public int RoofAreaEX { get { return this.roofAreaEX; } }
    /// <summary>
    /// Returns the assumed roof area in sq. ft. of this Dsc
    /// </summary>
    public int RoofAreaFB { get { return this.roofAreaFB; } }
    /// <summary>
    /// Returns the existing condition parking lot area in sq. ft. of this Dsc
    /// </summary>
    public int ParkAreaEX { get { return this.parkAreaEX; } }
    /// <summary>
    /// Returns the assumed parking lot area in sq. ft. of this Dsc
    /// </summary>
    public int ParkAreaFB { get { return this.parkAreaFB; } }
    public int ICRoofEX { get { return this.icRoofEX; } }
    public int ICRoofFB { get { return this.icRoofFB; } }
    public int ICParkEX { get { return this.icParkEX; } }
    public int ICParkFB { get { return this.icParkFB; } }
    public double EICRoofEX { get { return this.eicRoofEX; } }
    public double EICRoofFB { get { return this.eicRoofFB; } }
    public double EICParkEX { get { return this.eicParkEX; } }
    public double EICParkFB { get { return this.eicParkFB; } }
    /// <summary>
