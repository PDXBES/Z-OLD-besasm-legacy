...
namespace SystemsAnalysis.Reporting.ReportLibraries
{
    ...
    {
        private AlternativePackage recPlanPackage;
        private PipeInspectionDataSet pipeInspectDS;

        /// <summary>
        /// Creates a RecommendedPlanReport from a collections of Links, Nodes and Dscs
        /// </summary>
        ...
        {
            this.OnStatusChanged(new StatusChangedArgs("Creating recommended plan objects."));

            pipeInspectDS = new PipeInspectionDataSet();
            DataAccess.PipeInspectionDataSetTableAdapters.PipeInspectionGradesTableAdapter pipeInspectTA;
            pipeInspectTA = new DataAccess.PipeInspectionDataSetTableAdapters.PipeInspectionGradesTableAdapter();
            pipeInspectTA.Fill(pipeInspectDS.PipeInspectionGrades);
        }
        ...
        public class ReportInfo : ReportBase.ReportInfo
        {
            ...
            private void SetAuxilaryDataDescription()
            {
                ...
                auxilaryDataDescription.Add("RecommendedPlanPath", "Alternative Package (alternative_package.mdb)");
            }
        ...
        public override void LoadAuxilaryData(Dictionary<string, Parameter> AuxilaryData)
        {
            ...
            {
                throw new Exception("Could not read auxilary data 'RecommendedPlanPath': " + ex.Message, ex);
            }
        }
