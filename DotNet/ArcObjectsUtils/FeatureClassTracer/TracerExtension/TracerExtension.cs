...
namespace SystemsAnalysis.Tracer
{
  ...
  public class TracerExtension : IExtension, IExtensionConfig, IDocumentEvents
  {
    ...
    {
      // Setup and check that a polyline layer has been selected
    ...
    /// <summary>
    /// Clear the traced subnetwork and retrace
    /// </summary>
    ...
    // TODO: Refactor following as it is very similar to SelectLink method
    /// <summary>
    /// Selects a link.  Used by external applications.
    /// </summary>
    /// <param name="sender">Sender object</param>
    /// <param name="e">Event arguments object</param>
    /// <returns>The selected IGraphEdge</returns>
