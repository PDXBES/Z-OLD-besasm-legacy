...
namespace SanitaryAnalysisTools
    {
    /// <summary>
    /// Summary description for UpdateMaybeNearbySW.
    /// </summary>
    [Guid ( "6fe0abf1-22e1-4427-bfc1-69fbdd774871" )]
    [ClassInterface ( ClassInterfaceType.None )]
    [ProgId ( "SanitaryAnalysisTools.UpdateMaybeNearbySW" )]
    public class UpdateMaybeNearbySW : BaseCommand
        {
        ...
        public UpdateMaybeNearbySW ()
            {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "Sanitary Analysis Tools"; //localizable text
            base.m_caption = "DSC Maybe Nearby Storm";  //localizable text
            base.m_message = "Sets the NearbySW to Maybe";  //localizable text 
            base.m_toolTip = "DSC Maybe Nearby Storm";  //localizable text 
            base.m_name = "SanA_DSCMaybeSW";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
        ...
        public override void OnClick ()
            ...
            try
                ...
                System.Windows.Forms.MessageBox.Show
                    ( ex.ToString (), "UpdateMaybeNearbySW OnClick Error" );
                }
            }    
        #endregion
        }
