...
namespace SanitaryAnalysisTools
    {
    /// <summary>
    /// Summary description for UpdateNoNearbySW.
    /// </summary>
    [Guid ( "c330aed1-6d6a-482c-b58a-fd27d87329ce" )]
    [ClassInterface ( ClassInterfaceType.None )]
    [ProgId ( "SanitaryAnalysisTools.UpdateNoNearbySW" )]
    public class UpdateNoNearbySW : BaseCommand
        {
        ...
        public UpdateNoNearbySW ()
            {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "Sanitary Analysis Tools"; //localizable text
            base.m_caption = "DSC No Nearby Storm";  //localizable text
            base.m_message = "Sets the NearbySW to No";  //localizable text 
            base.m_toolTip = "DSC No Nearby Storm";  //localizable text 
            base.m_name = "SanA_DSCNoSW";   //unique id, non-localizable (e.g. "MyCategory_ArcMapCommand")
        ...
        public override void OnClick ()
            {
            // TODO: Add UpdateNoNearbySW.OnClick implementation
            try
                {
                ...
                System.Windows.Forms.MessageBox.Show
                    ( ex.ToString (), "UpdateNoNearbySW OnClick Error" );
                }
            }    
        #endregion
        }
