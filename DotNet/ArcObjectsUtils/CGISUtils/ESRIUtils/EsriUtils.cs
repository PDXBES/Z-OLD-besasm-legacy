...
namespace CGIS.MapWorks
{
    ...
    public class EsriUtils
    {
        ...
        { NO_OVERRIDE, ALLWAYS_SELECTABLE, NEVER_SELECTABLE }



        public enum HideLayerOverrideEnum

        { NO_OVERRIDE, ALLWAYS_HIDE, NEVER_HIDE }



        public enum LayerVisibleOverrideEnum

        { NO_OVERRIDE, ALLWAYS_VISIBLE, NEVER_VISIBLE }



        public enum SelectionModifierEnum

        { NO_MODIFIER, ADD_TO_SELECTION, SUBTRACT_FROM_SELECTION }
        ...
        public static string PromptForMapDocument()
        {
            ...
            mapFileDialog.Filter = "ArcMap Documents (*.mxd)|*.mxd|ArcMap Templates (*.mxt)|*.mxt|Published Maps (*.pmf)|*.pmf|All Supported Map Formats|*.mxd;*.mxt;*.pmf";
        ...
        public static ILayer[] GetAllLayers(IMap esriMap, bool includeContainerObjects)
        {
            ...
            System.Collections.ArrayList mapLayersArrayList = CGIS.MapWorks.EsriUtils.getAllLayers(esriMap, includeContainerObjects);
            // transform array list to array and return it
            return CGIS.MapWorks.EsriUtils.layerArrayListToArray(mapLayersArrayList);
        }
        ...
        public static ILayer[] GetSelectableLayers(IMap esriMap)
        {
            ...
            System.Collections.ArrayList tempArrayList = CGIS.MapWorks.EsriUtils.getAllLayers(esriMap, false);
            ...
            if (tempArrayList != null)
            {
                ...
                while (tempArrayEnumerator.MoveNext())
                {
                    ...
                    if (CGIS.MapWorks.EsriUtils.LayerIsValid(esriLayer) == true)
                    {
            ...
            return CGIS.MapWorks.EsriUtils.layerArrayListToArray(finalArrayList);
        }
        ...
        {
            // get all layers in the map
            System.Collections.ArrayList tempArrayList = CGIS.MapWorks.EsriUtils.getAllLayers(esriMap, true);
            // create an empty array list to place layers that match criteria
            System.Collections.ArrayList finalArrayList = new System.Collections.ArrayList();
            if (tempArrayList != null)
            {
        ...
        {
            return CGIS.MapWorks.EsriUtils.GetAllLayersByName(layerName, esriMap, true);
        }
        ...
        {
            return CGIS.MapWorks.EsriUtils.GetOneLayerByName(layerName, esriMap, true);
        }
        ...
        public static ILayer GetOneLayerByName(string layerName, IMap esriMap, bool ignoreCase)
        {
            ...
            ILayer[] esriLayers = CGIS.MapWorks.EsriUtils.GetAllLayersByName(layerName, esriMap, ignoreCase);
            if (esriLayers == null)
        ...
        {
            return CGIS.MapWorks.EsriUtils.GetAllLayersByFieldName(fieldName, esriMap, false);
        }
        ...
        {
            return CGIS.MapWorks.EsriUtils.GetOneLayerByFieldName(fieldName, esriMap, false);
        }
        ...
        {
            // get array of all layers based on the input table name
            ILayer[] esriLayers = CGIS.MapWorks.EsriUtils.GetAllLayersByFieldName(fieldName, esriMap, withSelectionOnly);
            if (esriLayers == null)
                // return null of array is null
                return null;
            else
        ...
        public static ILayer[] GetAllLayersByTableName(string tableName, IMap esriMap)
        {
            ...
            if (tempArrayList != null)
            {
                ...
                while (tempArrayEnumerator.MoveNext())
                {
                    ...
                    ILayer esriLayer = (ILayer)tempArrayEnumerator.Current;
                    // return the layer's table name
                    string currentTableName = CGIS.MapWorks.EsriUtils.GetLayerTableName(esriLayer);
                    // compare it with the input string (case insensitive)
        ...
        {
            // get array of all layers based on the input table name
            ILayer[] esriLayers = CGIS.MapWorks.EsriUtils.GetAllLayersByTableName(tableName, esriMap);
            if (esriLayers == null)
                // return null of array is null
                return null;
            else
        ...
        public static ILayer[] GetChildLayers(ILayer esriLayer, bool includeContainerObjects)
        {
            ...
            {
                esriLayerArrayList = CGIS.MapWorks.EsriUtils.addLayerToArrayList(esriLayer, includeContainerObjects, esriLayerArrayList);
                return CGIS.MapWorks.EsriUtils.layerArrayListToArray(esriLayerArrayList);
            }
            return null;
        }
            ...
            if (CGIS.MapWorks.EsriUtils.LayerIsValid(esriLayer) == true)
            {
                ...
                if (esriLayer is IDataLayer2)
                {
                    ...
                    if (esriLayer is IRasterLayer)
                    {
                        ...
                        layerTableName = CGIS.MapWorks.EsriUtils.getRasterTableName(esriRasterLayer);
                    }
                    else
                    {
        ...
        /// <returns>An ESRI ILayer object</returns>
        public static ILayer LoadLayerFile(string fullPath, AxMapControl mapControl)
        {
        ...
        public static ILayer CloneLayer(ILayer inputEsriLayer)
        {
            ...
            ILayer clone = (ILayer)CGIS.MapWorks.EsriUtils.DeepClone((IPersistStream)inputEsriLayer);
            return clone;
        }
        ...
        public static void AddGeometryAsGraphicToMap(IGeometry sourceGeometry, ISymbol esriSymbol, IMap targetMap, IPropertySet graphicProperties, string graphicName)
        {
            if (CGIS.MapWorks.EsriUtils.GeometryIsValid(sourceGeometry) == false)
                return;
            ...
            {
                graphicElement = new MarkerElementClass();
            ...
            {
                graphicElement = new PolygonElementClass();
                graphicElement.Geometry = sourceGeometry;
            ...
            {
                graphicElement = new LineElementClass();
                graphicElement.Geometry = sourceGeometry;
        ...
        /// </remarks>
        public static ISymbol LoadStyleGallerySymbol(string styleFile, string styleClass, string styleName, string styleCategory)
        {
        ...
        {
            if (CGIS.MapWorks.EsriUtils.GeometryIsValid(inputGeometry) == false)
                return null;
        ...
        public static IGeometry UnionGeometries(IFeatureCursor featureCursor)
        {
            try
            {
                IFeature[] featureArray = CGIS.MapWorks.EsriUtils.FeatureCursorToArray(featureCursor);
                return CGIS.MapWorks.EsriUtils.UnionGeometries(featureArray);
            }
            catch
            {
                return null;
        ...
        public static IGeometry CalculateBuffer(IFeature inputFeature, double distanceInFeet)
        {
            ...
            try
            {
                return CGIS.MapWorks.EsriUtils.CalculateBuffer(inputGeometry, distanceInFeet);
            }
            catch
            {
                return null;
        ...
        {
            if ((CGIS.MapWorks.EsriUtils.GeometryIsValid(inputGeometry) == false) || (distanceInFeet == 0) || (inputGeometry is ITopologicalOperator == false))
                return null;
        ...
        {
            SdeWorkspaceFactoryClass sdeWorkspaceFactory = new SdeWorkspaceFactoryClass();
            try
            {
        ...
        /// <returns>An ESRI IWorkspace object</returns>
        /// <remarks>Will re-throw any errors raised by the ESRI IWorkspaceFactory.Open() method</remarks>
        public static IWorkspace OpenWorkspace(string server, string instance, string database, string version, string user, string password)
        {
            if (version == null || version == "")
                version = "sde.DEFAULT";

            PropertySet esriPropertySet = new PropertySetClass();
            ...
            try
            {
                return CGIS.MapWorks.EsriUtils.OpenWorkspace(esriPropertySet);
            }
            catch
            {
                throw;
        ...
        /// <remarks>Will re-throw any errors raised by the ESRI IFeatureWorkspace.OpenFeatureClass() method or a generic <c>System.Exception</c> if the input IWorkspace is null or fails to support IFeatureWorkspace</remarks>
        public static IFeatureClass OpenFeatureClass(string featureClassTableName, IWorkspace sourceWorkspace)
        {
            if (sourceWorkspace != null)
            {
                ...
                {
                    throw new System.Exception("Failed to open featureclass '" + featureClassTableName + "', the workspace object provided does not support IFeatureWorkspace");
                }
            }
            else
            {
                throw new System.Exception("Failed to open featureclass '" + featureClassTableName + "', the workspace object provided was null.");
            }
        }
        ...
        public static ILocator OpenLocater(string locaterName, IWorkspace sourceWorkspace)
        {
            if (sourceWorkspace != null)
            {
                try
                {
                    ILocatorManager2 locaterManager = new LocatorManagerClass();
        ...
        {
            if ((CGIS.MapWorks.EsriUtils.GeometryIsValid(geometry) == false) || map == null)
                return false;
            try
            {
        ...
        public static void ZoomToGeometry(IGeometry geometry, IMap map, double expansionFactor)
        {
            ...
            if (expansionFactor != 0)
                geometryEnvelope.Expand(expansionFactor, expansionFactor, true);
            IActiveView activeView = (IActiveView)map;
            activeView.Extent = geometryEnvelope;
        }
        ...
        private static System.Collections.ArrayList addLayerToArrayList(ILayer esriLayer, bool includeContainerObjects, System.Collections.ArrayList inArrayList)
        {
            if (inArrayList == null)
            ...
            if (esriLayer != null)
            {
                if (esriLayer is ICompositeLayer)
                {
                    ...
                    for (esriChildLayerIndex = 0; esriChildLayerIndex != esriChildLayerCount; esriChildLayerIndex++)
                    {
                        ...
                        {
                            CGIS.MapWorks.EsriUtils.addLayerToArrayList(esriChildLayer, includeContainerObjects, inArrayList);
                        }
                        esriChildLayer = null;
                    }
