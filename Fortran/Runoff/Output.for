C     Last change:  AMM   3 Apr 2000    2:34 pm
      SUBROUTINE OUTPUT
C=======================================================================
...
C     THAT IS, INCREASE FROM CHECK FOR .LE.0 TO .LE.0.001.
cim try leaving 0.0
cim   IF(QOU(J).LE.0.001) GO TO 119
...
C#### WCH, 11/29/93.  CHANGE DIAMETER/DEPTH PRINT TO METERS.
  ...
  801 FORMAT(/,
     ...
     +------  ----------   -------  --------    ---------   -----  -----
     +-')
  802 FORMAT(' ',I8,1PE8.2,2X,0PF8.2,1X,F9.3,1X,1PE9.2,I6,I6,2X,
     +             0PF8.2,I6,I6,2(1X,F8.2),4X,F8.2,3X,F7.1,2X,F7.5)
  803 FORMAT(' ',I8,'   UNDEF',2(2X,'   UNDEF'),1X,1PE9.2,I6,I6)
  813 FORMAT(' ',A10,' UNDEF',2(2X,'   UNDEF'),1X,1PE9.2,I6,I6)
  812 FORMAT(' ',A8,1PE8.2,2X,0PF8.2,1X,F9.3,1X,1PE9.2,I6,I6,2X,
     +             0PF8.2,I6,I6,2(1X,F8.2),4X,F8.2,3X,F7.1,2X,F7.5)
  940 FORMAT(/,1H1,/,10X,
     +' **************************************************',/,10X,
