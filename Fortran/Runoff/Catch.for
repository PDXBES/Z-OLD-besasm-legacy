C     Last change:  AMM  28 Nov 2000    4:05 pm
...
cc      if( N .LE.3 )then
cc        write(N6,*)' warea war(3,N) pzero ',WAREA(N),WAR(3,N),PZERO
cc        write(*,*)' warea war(3,N) pzero ',WAREA(N),WAR(3,N),PZERO
cc        end if
...
C=======================================================================
  770 FORMAT(1H1,//,
     ...
     +'  ***************************************************',/)
  780 FORMAT(' SUBCATCHMENT      CHANNEL   WIDTH   AREA   PERCENT   ',
     &'SLOPE    RESISTANCE FACTOR  DEPRES. STORAGE(IN)    INFILTRATION',
     1'  DECAY RATE   GAGE',/,'      NUMBER    OR INLET     (FT)    ',
     2'(AC)   IMPERV.  (FT/FT)     IMPERV.   PERV.    IMPERV.    PERV.',
     3'       RATE(IN/HR)    (1/SEC)   NO.',/,T104,'MAXIMUM MINIMUM',/,
     5' ---  -------   --------    ------   ------  -----   -------',
     6'    ------    ------    ------    ------     ----   -------  ',
     7'-------  -----')
  782 FORMAT(' SUBCATCHMENT      CHANNEL   WIDTH   AREA   PERCENT   ',
     &'SLOPE    RESISTANCE FACTOR  DEPRES. STORAGE(MM)    INFILTRATION',
     1'  DECAY RATE   GAGE',/,'      NUMBER    OR INLET      (M)    ',
     2'(HA)   IMPERV.  (M/M)       IMPERV.   PERV.    IMPERV.    PERV.',
     3'       RATE(MM/HR)    (1/SEC)   NO.',/,T104,'MAXIMUM MINIMUM',/,
     5' ---  -------   --------    ------   ------  -----   -------',
     6'    ------    ------    ------    ------     ----   -------  ',
     7'-------  -----')
  784 FORMAT(' SUBCATCHMENT    GUTTER      WIDTH   AREA   PERCENT   ',
     &'SLOPE    RESISTANCE FACTOR  DEPRES. STORAGE(IN)  GREEN-AMPT ',
     1'INFIL PARAMS     GAGE',/,'      NUMBER    OR INLET     (FT)    ',
     3'(AC)   IMPERV.  (FT/FT)     IMPERV.   PERV.    IMPERV.    PERV.',
     4'   SUCTION  HYD.CON    IMD      NO.',/,T106,'(IN)   (IN/HR)',/,
     6' ---  -------   --------    ------   ------  -----   -------',
     7'    ------    ------    ------    ------     ----   -------  ',
     8'-------  -----')
  786 FORMAT(' SUBCATCHMENT    GUTTER   WIDTH   AREA   PERCENT   SLOPE',
     &'    RESISTANCE FACTOR  DEPRES. STORAGE(MM)  GREEN-AMPT INFIL ',
     1'PARAMS     GAGE',/,'      NUMBER    OR INLET  (M)    (HA)   ',
     2'IMPERV.  (M/M)       IMPERV.   PERV.    IMPERV.    PERV.   ',
     3'SUCTION  HYD.CON    IMD      NO.',/,T106,'(MM)   (MM/HR)',/,
     6' ---  -------   --------    ------   ------  -----   -------',
     7'    ------    ------    ------    ------     ----   -------  ',
     8'-------  -----')
c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 7801 FORMAT(' SUBCATCHMENT      CHANNEL   WIDTH   AREA   PERCENT   ',
     &'SLOPE    RESISTANCE FACTOR  DEPRES. STORAGE(IN)    INFILTRATION',
     1'  DECAY RATE   GAGE',/,'      NUMBER    OR INLET     (FT)    ',
     2'(AC)   IMPERV.  (FT/FT)     IMPERV.   PERV.    IMPERV.    PERV.',
     3'       RATE(IN/HR)    (1/SEC)   NO.',/,T104,'MAXIMUM MINIMUM',/,
     ...
     6'    ------    ------    ------    ------     ----   -------  ',
     7'-------  -----')
 7821 FORMAT(' SUBCATCHMENT      CHANNEL   WIDTH   AREA   PERCENT   ',
     &'SLOPE    RESISTANCE FACTOR  DEPRES. STORAGE(MM)    INFILTRATION',
     1'  DECAY RATE   GAGE',/,'      NUMBER    OR INLET      (M)    ',
     2'(HA)   IMPERV.  (M/M)       IMPERV.   PERV.    IMPERV.    PERV.',
     3'       RATE(MM/HR)    (1/SEC)   NO.',/,T104,'MAXIMUM MINIMUM',/,
     ...
     6'    ------    ------    ------    ------     ----   -------  ',
     7'-------  -----')
 7841 FORMAT(' SUBCATCHMENT    GUTTER      WIDTH   AREA   PERCENT   ',
     &'SLOPE    RESISTANCE FACTOR  DEPRES. STORAGE(IN)  GREEN-AMPT ',
     1'INFIL PARAMS     GAGE',/,'      NUMBER    OR INLET     (FT)    ',
     3'(AC)   IMPERV.  (FT/FT)     IMPERV.   PERV.    IMPERV.    PERV.',
     4'   SUCTION  HYD.CON    IMD      NO.',/,T106,'(IN)   (IN/HR)',/,
     ...
     7'    ------    ------    ------    ------     ----   -------  ',
     8'-------  -----')
 7861 FORMAT(' SUBCATCHMENT    GUTTER   WIDTH   AREA   PERCENT   SLOPE',
     &'    RESISTANCE FACTOR  DEPRES. STORAGE(MM)  GREEN-AMPT INFIL ',
     1'PARAMS     GAGE',/,'      NUMBER    OR INLET  (M)    (HA)   ',
     2'IMPERV.  (M/M)       IMPERV.   PERV.    IMPERV.    PERV.   ',
     3'SUCTION  HYD.CON    IMD      NO.',/,T106,'(MM)   (MM/HR)',/,
...
C#### WCH, 4/27/93.
  856 FORMAT(' ===> WARNING! IMPERVIOUSNESS OF',F7.2,' IS > 100%.  RE-SE
     1T TO LIMIT OF 100 %.') 
  870 FORMAT(1X,I4,I9,2X,I9,1X,F9.2,F9.2,F7.2,F10.4,1X,4F10.3,F9.2,F8.2,
     1F11.5,I6)
C#### WCH, 12/5/94. CHANGE LAST F10.2 TO F10.3.
  871 FORMAT(1X,I4,I9,2X,I9,1X,F9.2,F9.2,F7.2,F10.4,1X,4F10.3,F9.2,F10.3
     1,F9.3,I8)
  872 FORMAT(1X,I4,1X,A10,1X,A10,1X,F8.2,F9.2,F7.2,F10.4,1X,4F10.3,
     +       F9.2,F8.2,F11.5,I6)
C#### WCH, 12/5/94. CHANGE LAST F10.2 TO F10.3.
  873 FORMAT(1X,I4,1X,A10,1X,A10,1X,F8.2,F9.2,F7.2,F10.4,1X,4F10.3,
     +       F9.2,F10.3,F9.3,I8)
c %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
 8701 FORMAT(1X,I4,I9,2X,I9,1X,F9.2,F9.2,F7.2,F10.4,1X,4F10.3,F9.2,F8.2,
     1F11.5,I6,f11.5)     
 8721 FORMAT(1X,I4,1X,A10,1X,A10,1X,F8.2,F9.2,F7.2,F10.4,1X,4F10.3,
     +       F9.2,F8.2,F11.5,I6,f11.5)
 8711 FORMAT(1X,I4,I9,2X,I9,1X,F9.2,F9.2,F7.2,F10.4,1X,4F10.3,F9.2,F10.3
     1,F9.3,I8,f11.5)
 8731 FORMAT(1X,I4,1X,A10,1X,A10,1X,F8.2,F9.2,F7.2,F10.4,1X,4F10.3,
...
C#### WCH, 12/5/94.
 ...
 1021 FORMAT(' ===> ERROR !! ONE OR MORE ELEVATIONS IN SUBCATCHMENT ',
     .A10,' ARE EXCEEDED BY',/,
     .'AT LEAST ONE ELEVATION THAT SHOULD BE LOWER.')
 1030 FORMAT(' ===> ERROR !! WILTING POINT FOR SUBCATCHMENT ',I3,
     +       ' IS GREATER THAN FIELD CAPACITY')
 1031 FORMAT(' ===> ERROR !! WILTING POINT FOR SUBCATCHMENT ',A10,
     +       ' IS GREATER THAN FIELD CAPACITY')
 1040 FORMAT(' ===> WARNING !! FIELD CAPACITY FOR SUBCATCHMENT ',I3,
...
C
 2305 FORMAT(
     +'  SUB-  CHANNEL     ========== E L E V A T I O N S ========  ====
     +======= F L O W   C O N S T A N T S ============',/,
     +'  CATCH      OR      GROUND  BOTTOM   STAGE     BC      TW
     +A1         B1        A2         B2        A3',/,
     +'  NUMBER  INLET       (FT)    (FT)     (FT)    (FT)    (FT) (IN/H
     +R-FT^B1)       (IN/HR-FT^B2)        (IN/HR-FT^2)  ',/,
     +'  ------  -----     -------  ------  ------  ------  ------ -----
     +------  ------- -----------  ------- -----------')
 2310 FORMAT(
     +'  SUB-  CHANNEL     ========== E L E V A T I O N S ========  ====
     ...
     +'  CATCH      OR      GROUND  BOTTOM   STAGE     BC      TW
     +A1         B1        A2         B2        A3',/,
     +'  NUMBER  INLET        (M)     (M)      (M)     (M)     (M) (MM/H
     +R-M^B1)         (MM/HR-M^B2)         (MM/HR-M^2)  ',/,
     +'  ------  -----     -------  ------  ------  ------  ------ -----
     +------  ------- -----------  ------- -----------')
 2315 FORMAT(2X,I6,2X,I5,6X,5(F6.2,2X),1PE10.3,2X,0PF7.3,2X,
     +       1PE10.3,2X,0PF7.3,1PE12.2)
 2335 FORMAT(1X,A10,1X,A9,5(F6.2,2X),1PE10.3,2X,0PF7.3,2X,
     +       1PE10.3,2X,0PF7.3,1PE12.2)
 2326 FORMAT(1H1,//,
     +' ***********************************************************',/,
     +' * G R O U N D W A T E R   I N P U T   D A T A (CONTINUED) *',/,
     +' ***********************************************************',//,
     116X,'S O I L   P R O P E R T I E S',/,21X,
     2'SATURATED',43X,'PERCOLATION',5X,'E T  P A R A M E T E R S',/,
     33X,'SUBCAT.',11X,'HYDRAULIC  WILTING  FIELD   INITIAL    ',
     4' MAX. DEEP',3X,'PARAMETERS',9X,'DEPTH  FRACTION OF ET',/,
     55X,'NO.   POROSITY CONDUCTIVITY  POINT  CAPACITY MOISTURE  ',
     6'PERCOLATION   HCO    PCO        OF ET  TO UPPER ZONE')
 2307 FORMAT(22X,'(in/hr)',32X,'(in/hr)',24X,'(ft)',/,
     +'    ----   ------     -------    ------  ------   ------    -----
     +-----  ------  ------     ------      ------')
C
...
C
 2308 FORMAT(22X,'(mm/hr)',32X,'(mm/hr)',24X,'(m)',/,
     +'    ----   ------     -------    ------  ------   ------    -----
     +-----  ------  ------     ------      ------')
 2309 FORMAT(5X,I3,4X,F5.4,5X,F7.3,5X,F5.4,3X,F5.4,4X,F5.4,4X,
     +       1PE10.3,2X,0PF6.2,1X,F7.2,5X,F6.2,7X,F5.3)
 2319 FORMAT(1X,A10,1X,F5.4,5X,F7.3,5X,F5.4,3X,F5.4,4X,F5.4,4X,
     +       1PE10.3,2X,0PF6.2,1X,F7.2,5X,F6.2,7X,F5.3)
C=======================================================================
      RETURN
  888 CALL IERROR
