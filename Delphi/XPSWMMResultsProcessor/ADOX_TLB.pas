...
// File generated on 10/2/01 11:07:38 AM from Type Library described below.
...
procedure TGroup.Set_Name(const pVal: WideString);
  { Warning: The property Name has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function  TGroup.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, EmptyParam);
end;

function  TGroup.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                                ObjectTypeId: OleVariant): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, ObjectTypeId);
end;

procedure TGroup.SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; Action: ActionEnum; 
                                Rights: RightsEnum; Inherit: InheritTypeEnum);
begin
...
procedure TGroupProperties.Set_Name(const pVal: WideString);
  { Warning: The property Name has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
procedure TUser.Set_Name(const pVal: WideString);
  { Warning: The property Name has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function  TUser.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, EmptyParam);
end;

function  TUser.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                               ObjectTypeId: OleVariant): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, ObjectTypeId);
end;

procedure TUser.SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; Action: ActionEnum; 
                               Rights: RightsEnum; Inherit: InheritTypeEnum);
begin
  DefaultInterface.SetPermissions(Name, ObjectType, Action, Rights, Inherit, EmptyParam);
end;
...
procedure TUser.ChangePassword(const OldPassword: WideString; const NewPassord: WideString);
begin
...
procedure TUserProperties.Set_Name(const pVal: WideString);
  { Warning: The property Name has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
