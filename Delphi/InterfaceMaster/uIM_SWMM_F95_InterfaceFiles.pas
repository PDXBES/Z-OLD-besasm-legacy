...
const
	IM_SWMMF95_TITLE_LENGTH = 80;
	IM_SWMMF95_SOURCEBLOCK_LENGTH = 20;
	IM_SWMMF95_ALPHAID_LENGTH = 10;
	IM_SWMMF95_FORMAT_DESC = 'SWMM-F95';
type

	T_SWMM_F95_InterfaceFile_NodeFilter = class(TInterfacedObject,
		IIM_ConvertFilter)
	private
		fID: String;
		fNewID: String;
	...
	T_SWMM_F95_InterfaceFileIO = class;
	{=============================================================================
...
{		procedure ConvertTo(ADestInterface: IIM_InterfaceFile;
	...
	{=============================================================================
		Name: T_SWMM_F95_ConvertFilterPackage
		Purpose: Provides filter information for a source XP interface file
		Requirements:
	=============================================================================}
	T_SWMM_F95_ConvertFilterPackage = class(TInterfacedObject,
	...
	T_SWMM_F95_StandardInterfaceFile_TimeSeriesData = class;
	{=============================================================================
		 Name: T_SWMM_F95_StandardInterfaceFile_DataIterator
		 ...
		 Restrictions: usage restricted to T_SWMM_F95_StandardInterfaceFile
	=============================================================================}
	T_SWMM_F95_StandardInterfaceFile_DataIterator = class(TInterfacedObject,
	...
	{=============================================================================
		 ...
		 Requirements: a T_SWMM_F95_StandardInterfaceFile_TimeSeriesDataIterator
	=============================================================================}
	...
	{=============================================================================
		 ...
		 Requirements: usage restricted to T_SWMM_F95_StandardInterfaceFile
	=============================================================================}
...
{ T_SWMM_F95_StandardInterfaceFile }

procedure T_SWMM_F95_StandardInterfaceFile.WriteInterface;
begin
	fHeader.WriteHeader;
end;

constructor T_SWMM_F95_StandardInterfaceFile.Create(AFile: TFileName;
	Mode: Word);
var
	i: Integer;
...
begin
	...
	fHeader := T_SWMM_F95_StandardInterfaceFileHeader.Create(Self);
	IO := T_SWMM_F95_InterfaceFileIO.Create(Self, fBuffer);
	if Mode <> fmCreate then
		fHeader.ReadHeader;
end;

procedure T_SWMM_F95_StandardInterfaceFile.SetHeaderValue(AIndex: String;
	Value: Variant);
begin
	Assert(false, 'T_SWMM_F95_StandardInterfaceFile.SetHeaderValue not implemented');
end;

function T_SWMM_F95_StandardInterfaceFile.GetIOServices: IIM_InterfaceFileIO;
begin
	Result := IO;
end;

function T_SWMM_F95_StandardInterfaceFile.GetTimeSeriesDataIterator: IIM_InterfaceTimeSeriesDataIterator;
begin
	Result := T_SWMM_F95_StandardInterfaceFile_DataIterator.Create(Self);
end;

function T_SWMM_F95_StandardInterfaceFile.GetHeaderValue(
	AIndex: String): Variant;
begin
	Assert(false, 'T_SWMM_F95_StandardInterfaceFile.GetHeaderValue not implemented');
end;

procedure T_SWMM_F95_StandardInterfaceFile.ReadInterface;
begin
	fHeader.ReadHeader;
end;

destructor T_SWMM_F95_StandardInterfaceFile.Destroy;
begin
	fBuffer.Free;
	fStream.Free;
	inherited;
...
function T_SWMM_F95_StandardInterfaceFile.GetHeader: IIM_InterfaceHeader;
begin
	Result := fHeader;
end;

procedure T_SWMM_F95_StandardInterfaceFile.ConvertFrom(
  ...
  fHeader.HeaderValue[IM_IFHDR_ISALPHA] := SourceHeader.HeaderValue[IM_IFHDR_ISALPHA];
	...
	begin
		for i := 0 to SourceHeader.NumIndexedHeaderValues-1 do
			fHeader.AddIndexedHeaderValue(SourceHeader.IndexedHeaderValue[i]);
	end;
...
//			CodeSite.SendNote('Filled SourceDataValues');
			...
			IO.WriteSingle(SecondsOfDayOfDateTime(SourceData.Time));
			IO.WriteSingle(SourceData.DataValue[IM_IF_TIMESTEP]);
...
function T_SWMM_F95_StandardInterfaceFile.GetFileName: TFileName;
begin
	Result := fFileName;
end;

function T_SWMM_F95_StandardInterfaceFile.GetFormat: String;
begin
	Result := IM_SWMMF95_FORMAT_DESC;
end;

{ T_SWMM_F95_StandardInterfaceFileHeader }

procedure T_SWMM_F95_StandardInterfaceFileHeader.WriteHeader;
var
	IO: IIM_InterfaceFileIO;
	i: Integer;
begin
...
constructor T_SWMM_F95_StandardInterfaceFileHeader.Create(
	AInterfaceFile: IIM_InterfaceFile);
begin
	fInterfaceFile := Pointer(AInterfaceFile);
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.SetFlowID(AIndex: Integer;
	Value: String);
begin
...
procedure T_SWMM_F95_StandardInterfaceFileHeader.SetSourceBlock(Value: String);
begin
	if CompareStr(fSourceBlock, Value) <> 0 then
		fSourceBlock := Value;
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetUsesAlphaNumericIDs: Boolean;
begin
	Result := True; // XP always uses alphanumeric IDs
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.SetTitles(AIndex: Integer;
	Value: String);
begin
...
function T_SWMM_F95_StandardInterfaceFileHeader.GetStartDate: TDateTime;
begin
	Result := fStartDate;
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.SetUsesAlphaNumericIDs(
	Value: Boolean);
begin
	// Do nothing; XP always uses alphanumeric IDs
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetArea: Double;
begin
	Result := fArea;
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetFlowMultiplier: Double;
begin
	Result := fFlowMultiplier;
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetFlowID(
	AIndex: Integer): String;
begin
	Result := fFlowIDs[AIndex];
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetSourceBlock: String;
begin
	Result := fSourceBlock;
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.SetStartDate(Value: TDateTime);
begin
	if not SameDateTime(fStartDate, Value) then
		fStartDate := Value;
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.ReadHeader;
var
...
begin
	IO := IIM_InterfaceFile(fInterfaceFile).GetIOServices;
	IO.MoveToBeginning;
	fTitles[1] := IO.ReadString(IM_SWMMF95_TITLE_LENGTH);
	fTitles[2] := IO.ReadString(IM_SWMMF95_TITLE_LENGTH);
	StartJulDate := IO.ReadInteger;
	StartTime := IO.ReadSingle;
	fStartDate := DateTimeOfJulDate(StartJulDate, StartTime);
	fTitles[3] := IO.ReadString(IM_SWMMF95_TITLE_LENGTH);
	fTitles[4] := IO.ReadString(IM_SWMMF95_TITLE_LENGTH);
	fSourceBlock := IO.ReadString(IM_SWMMF95_SOURCEBLOCK_LENGTH);
...
procedure T_SWMM_F95_StandardInterfaceFileHeader.SetArea(Value: Double);
begin
	if not SameValue(Value, fArea, IM_EPSILON) then
		fArea := Value;
end;

destructor T_SWMM_F95_StandardInterfaceFileHeader.Destroy;
begin
	fInterfaceFile := nil;
	inherited;
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetTitles(
	AIndex: Integer): String;
begin
	Result := fTitles[AIndex];
end;

function T_SWMM_F95_StandardInterfaceFileHeader.Size: Int64;
begin
	Result :=
		IM_SWMMF95_TITLE_LENGTH +
		IM_SWMMF95_TITLE_LENGTH +
		SizeOf(Integer) + SizeOf (Single) +
		IM_SWMMF95_TITLE_LENGTH +
		IM_SWMMF95_TITLE_LENGTH +
		IM_SWMMF95_SOURCEBLOCK_LENGTH +
		SizeOf(Integer) + SizeOf(Integer) + SizeOf(Single) +
		fNumFlows * IM_SWMMF95_ALPHAID_LENGTH +
		SizeOf(Single);
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.SetHeaderValue(AIndex: String;
	Value: Variant);
begin
    ...
    fUsesAlphaNumericIDs := Value
		...
		raise EIMSetHeaderValue.CreateFmt('Called T_SWMM_F95_StandardInterfaceFileHeader.'+
			'SetHeaderValue with %s = %s', [AIndex, Value]);
end;

function T_SWMM_F95_StandardInterfaceFileHeader.GetHeaderValue(
  AIndex: String): Variant;
begin
	if AIndex = IM_IFHDR_TITLE1 then
		Result := fTitles[1]
...
function T_SWMM_F95_StandardInterfaceFileHeader.GetIndexedHeaderValue(
	AIndex: Integer): Variant;
begin
	Result := fFlowIDs[AIndex];
end;

function T_SWMM_F95_StandardInterfaceFileHeader.NumIndexedHeaderValues: Integer;
begin
	Result := Length(fFlowIDs);
end;

procedure T_SWMM_F95_StandardInterfaceFileHeader.SetIndexedHeaderValue(
	AIndex: Integer; Value: Variant);
begin
	fFlowIDs[AIndex] := Value;
end;

function T_SWMM_F95_StandardInterfaceFileHeader.AddIndexedHeaderValue(
...
procedure T_SWMM_F95_StandardInterfaceFileHeader.ClearIndexedHeaderValues;
begin
	SetLength(fFlowIDs, 0);
	Finalize(fFlowIDs);
end;

{ T_SWMM_F95_InterfaceFileIO }

function T_SWMM_F95_InterfaceFileIO.ReadByte: Byte;
var
	Buf: Byte;
begin
...
function T_SWMM_F95_InterfaceFileIO.ReadExtended: Extended;
var
	Buf: Extended;
begin
...
procedure T_SWMM_F95_InterfaceFileIO.MoveToEnd;
begin
	MoveTo(0, soEnd);
end;

function T_SWMM_F95_InterfaceFileIO.MoveTo(Offset: Int64;
...
function T_SWMM_F95_InterfaceFileIO.ReadString: String;
begin
	Result := '';
end;

function T_SWMM_F95_InterfaceFileIO.ReadString(ALength: Integer): String;
var
	Buf: String;
begin
...
function T_SWMM_F95_InterfaceFileIO.ReadInteger: Integer;
var
	Buf: Integer;
begin
...
procedure T_SWMM_F95_InterfaceFileIO.MoveToBeginningOfData;
begin
	fStream.Seek(IIM_InterfaceFile(fInterfaceFile).GetHeader.Size, soBeginning);
end;

procedure T_SWMM_F95_InterfaceFileIO.PreviousLine;
begin
	// No record markers in XP interface files; don't do anything
end;

procedure T_SWMM_F95_InterfaceFileIO.NextLine;
begin
	// No record markers in XP interface files; don't do anything
end;

function T_SWMM_F95_InterfaceFileIO.Position: Int64;
begin
	Result := fStream.Position;
end;

function T_SWMM_F95_InterfaceFileIO.Size: Int64;
begin
	Result := fStream.FastSize;
end;

{ T_SWMM_F95_StandardInterfaceFile_DataIterator }

function T_SWMM_F95_StandardInterfaceFile_DataIterator.HasNext: Boolean;
begin
	Result := not IIM_InterfaceFile(fInterfaceFile).GetIOServices.IsEOF;
end;

constructor T_SWMM_F95_StandardInterfaceFile_DataIterator.Create(
	AInterfaceFile: IIM_InterfaceFile);
begin
	fInterfaceFile := Pointer(AInterfaceFile);
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.PreviousTime: TDateTime;
begin
	Result := fPreviousTime;
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.CurrentTimeStep: Double;
begin
...
function T_SWMM_F95_StandardInterfaceFile_DataIterator.NextTime: TDateTime;
begin
	Result := fNextTime;
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.Current: IIM_InterfaceTimeSeriesData;
begin
	Result := IIM_InterfaceTimeSeriesData(fData);
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.CurrentTime: TDateTime;
begin
	Result := IIM_InterfaceTimeSeriesData(fData).Time;
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.Previous: IIM_InterfaceTimeSeriesData;
var
	IO: IIM_InterfaceFileIO;
...
begin
	...
	begin
		...
		begin
			SecondPreviousData := T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Create(
				IIM_InterfaceFile(fInterfaceFile), Self);
			fPreviousTime := SecondPreviousData.Time;
		end;
		Result := T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Create(
			IIM_InterfaceFile(fInterfaceFile), Self);
...
destructor T_SWMM_F95_StandardInterfaceFile_DataIterator.Destroy;
begin
	fData := nil;
	fInterfaceFile := nil;
	inherited;
...
function T_SWMM_F95_StandardInterfaceFile_DataIterator.Next: IIM_InterfaceTimeSeriesData;
var
	IO: IIM_InterfaceFileIO;
...
begin
	...
	begin
		...
		if Assigned(fData) then
			...
			fPreviousTime := MinDateTime;
		fData := nil;
		Result := T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Create(IIM_InterfaceFile(fInterfaceFile), Self);
		fCurrentTimeStep := Result.DataValue[IM_IF_TIMESTEP];
		fData := Pointer(Result);
		fCurrentTime:= Result.Time;
		if IO.IsEOF then
		...
		begin
//			SecondNextData := T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Create(IIM_InterfaceFile(fInterfaceFile),
//				Self);
...
function T_SWMM_F95_StandardInterfaceFile_DataIterator.HasPrevious: Boolean;
begin
	Result := not IIM_InterfaceFile(fInterfaceFile).GetIOServices.IsBeginningOfData;
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.PositionPercent: Integer;
var
	IFPos: Int64;
	IFSize: Int64;
	IO: IIM_InterfaceFileIO;
...
function T_SWMM_F95_StandardInterfaceFile_DataIterator.Position: Int64;
begin
	Result := IIM_InterfaceFile(fInterfaceFile).GetIOServices.Position;
end;

function T_SWMM_F95_StandardInterfaceFile_DataIterator.DataValidUntilTime: TDateTime;
begin
...
{ T_SWMM_F95_StandardInterfaceFile_TimeSeriesData }

constructor T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Create
	(AInterfaceFile: IIM_InterfaceFile;
	AIterator: IIM_InterfaceTimeSeriesDataIterator);
var
	IO: IIM_InterfaceFileIO;
...
begin
	...
	Seconds := IO.ReadSingle;
	fTime := DateTimeOfJulDate(JulDate, Seconds);
	fTimeStep := IO.ReadSingle;
	ReadData;
end;

procedure T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.SetIndexedDataValue(
	AIndex: Integer; Value: Variant);
begin
...
function T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.GetDataValue(
	AIndex: String): Variant;
begin
...
function T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.GetIndexedDataValue(
	AIndex: Integer): Variant;
begin
	Result := fIndexedData[AIndex];
end;

procedure T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.SetDataValue(
...
procedure T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.ReadData;
var
	i: Integer;
...
begin
	...
	for i := 0 to NumDataPoints-1 do
		fIndexedData[i] := IO.ReadSingle;
end;

destructor T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Destroy;
begin
	fInterfaceFile := nil;
	inherited;
end;

procedure T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.WriteData;
var
	i: Integer;
	Header: IIM_InterfaceHeader;
	IO: IIM_InterfaceFileIO;
...
begin
	...
	IO.WriteSingle(SecondsOfDayOfDateTime(fTime));
...
function T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.Size: Int64;
begin
	Result := SizeOf(Integer) + SizeOf(Double) + SizeOf(Double) +
		NumIndexedDataValues * SizeOf(Double);
end;

function T_SWMM_F95_StandardInterfaceFile_TimeSeriesData.NumIndexedDataValues: Integer;
begin
	Result := Length(fIndexedData);
end;

{ T_SWMM_F95_InterfaceFile_NodeFilter }

constructor T_SWMM_F95_InterfaceFile_NodeFilter.Create(AID, ANewID, ANewSeries: String;
...
constructor T_SWMM_F95_InterfaceFile_NodeFilter.Create;
begin
	// Do nothing
end;

function T_SWMM_F95_InterfaceFile_NodeFilter.GetInclude: Boolean;
begin
	Result := fInclude;
end;

function T_SWMM_F95_InterfaceFile_NodeFilter.GetID: String;
begin
	Result := fID;
end;

function T_SWMM_F95_InterfaceFile_NodeFilter.GetExpression: String;
begin
	Result := fExpression;
end;

procedure T_SWMM_F95_InterfaceFile_NodeFilter.SetInclude(Value: Boolean);
begin
	if Value <> fInclude then
		fInclude := Value;
end;

procedure T_SWMM_F95_InterfaceFile_NodeFilter.SetID(Value: String);
begin
	if CompareStr(Value, fID) <> 0 then
		fID := Value;
end;

function T_SWMM_F95_InterfaceFile_NodeFilter.GetNewID: String;
begin
	Result := fNewID;
end;

procedure T_SWMM_F95_InterfaceFile_NodeFilter.SetExpression(Value: String);
begin
	if CompareStr(Value, fExpression) <> 0 then
		fExpression := Value;
end;

destructor T_SWMM_F95_InterfaceFile_NodeFilter.Destroy;
begin
	// Do nothing
	inherited;
end;

procedure T_SWMM_F95_InterfaceFile_NodeFilter.SetNewID(Value: String);
begin
	if CompareStr(Value, fNewID) <> 0 then
		fNewID := Value;
end;

function T_SWMM_F95_InterfaceFile_NodeFilter.GetNewSeries: String;
begin
	Result := fNewSeries;
end;

procedure T_SWMM_F95_InterfaceFile_NodeFilter.SetNewSeries(Value: String);
begin
	if CompareStr(Value, fNewSeries) <> 0 then
		fNewSeries := Value;
end;

function T_SWMM_F95_InterfaceFile_NodeFilter.GetFinalID: String;
begin
...
{ T_SWMM_F95_ConvertFilterPackage }

procedure T_SWMM_F95_ConvertFilterPackage.SetupFilters(
...
begin
	...
	fFilters.Clear;
	for i := 0 to SourceHeader.NumIndexedHeaderValues-1 do
		AddFilter(T_SWMM_F95_InterfaceFile_NodeFilter.Create(
			SourceHeader.IndexedHeaderValue[i]));
end;

function T_SWMM_F95_ConvertFilterPackage.NumIncludes: Integer;
var
	NumIncluded: Integer;
	Intf: IInterface;
begin
...
function T_SWMM_F95_ConvertFilterPackage.GetFilter(
  AIndex: Integer): IIM_ConvertFilter;
begin
	Result := IIM_ConvertFilter(fFilters[AIndex]);
end;

procedure T_SWMM_F95_ConvertFilterPackage.DeleteFilter(
  AFilter: IIM_ConvertFilter);
begin
	fFilters.Delete(fFilters.IndexOf(AFilter));
end;

function T_SWMM_F95_ConvertFilterPackage.IncludeLookup: TIndexLookupList;
var
	i: Integer;
begin
...
function T_SWMM_F95_ConvertFilterPackage.IsIncluded(AIndex: Integer): Boolean;
begin
	Result := IIM_ConvertFilter(fFilters[AIndex]).Include;
end;

function T_SWMM_F95_ConvertFilterPackage.GetFilterByID(
...
procedure T_SWMM_F95_ConvertFilterPackage.SetFilter(AIndex: Integer;
...
procedure T_SWMM_F95_ConvertFilterPackage.AddFilter(AFilter: IIM_ConvertFilter);
begin
	fFilters.Add(AFilter);
end;

procedure T_SWMM_F95_ConvertFilterPackage.SetFilterByID(ID: String;
	Value: IIM_ConvertFilter);
var
	i: Integer;
begin
...
constructor T_SWMM_F95_ConvertFilterPackage.Create;
begin
	fFilters := TInterfaceList.Create;
end;

destructor T_SWMM_F95_ConvertFilterPackage.Destroy;
begin
	fFilters.Free;
  inherited;
end;
